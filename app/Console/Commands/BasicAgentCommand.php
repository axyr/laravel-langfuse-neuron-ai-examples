...
class BasicAgentCommand extends Command
{
    ...
    public function handle(): int
    {
        $this->header(
            ...
            'Auto-tracing with zero Langfuse code. Just enable LANGFUSE_NEURON_AI_ENABLED=true.',
        );
        ...
        $response = (new Summarizer())->chat(new UserMessage($text))->getMessage()->getContent();
