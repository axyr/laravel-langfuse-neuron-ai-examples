...
class RagPipelineCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        $documents = [
            ...
            'The laravel-langfuse package auto-instruments Neuron AI calls with zero configuration.',
        ];
        ...
        // --- Answer generation (auto-traced via NeuronAiSubscriber) ---
        $this->line('  <fg=gray>Step 3: Generating answer...</>');

        $response = (new RagAnswerer(context: $context))->chat(new UserMessage($question))->getMessage()->getContent();
