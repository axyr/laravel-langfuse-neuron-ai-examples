...
class PromptManagementCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        $response = (new PromptDrivenAgent(compiledPrompt: $compiled))
            ->chat(new UserMessage('Explain LLM observability and why it matters for production applications.'))->getMessage()->getContent();
